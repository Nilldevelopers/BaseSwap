...
export interface SwapPairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface SwapPair extends BaseContract {
  connect(runner?: ContractRunner | null): SwapPair;
  waitForDeployment(): Promise<this>;

  interface: SwapPairInterface;
