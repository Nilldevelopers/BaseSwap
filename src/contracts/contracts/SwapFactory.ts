...
export interface SwapFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INIT_CODE_PAIR_HASH"
      | "allPairs"
...
export interface SwapFactory extends BaseContract {
  connect(runner?: ContractRunner | null): SwapFactory;
  waitForDeployment(): Promise<this>;

  interface: SwapFactoryInterface;
