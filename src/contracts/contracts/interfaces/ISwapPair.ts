...
export interface ISwapPairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface ISwapPair extends BaseContract {
  connect(runner?: ContractRunner | null): ISwapPair;
  waitForDeployment(): Promise<this>;

  interface: ISwapPairInterface;
