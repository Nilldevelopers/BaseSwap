...
export interface ISwapFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "INIT_CODE_PAIR_HASH"
      | "allPairs"
...
export interface ISwapFactory extends BaseContract {
  connect(runner?: ContractRunner | null): ISwapFactory;
  waitForDeployment(): Promise<this>;

  interface: ISwapFactoryInterface;
